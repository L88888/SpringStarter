package com.tgl.raft.concurrent;
...
public class TglRaftThreadPoolExecutor extends ThreadPoolExecutor {
     ...
     * @param handler 线程池队列满了之后如何设置拒绝策略
     */
    public TglRaftThreadPoolExecutor(int corePoolSize,
                                     int maximumPoolSize,
                                     long keepAliveTime,
                                     TimeUnit unit,
        ...
        super(corePoolSize, maximumPoolSize, keepAliveTime, unit, workQueue, myTglThreadFactory,handler);
    }
