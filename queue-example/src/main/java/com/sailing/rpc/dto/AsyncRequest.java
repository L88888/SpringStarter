...
@Getter
@ToString
public class AsyncRequest<T> implements Serializable {
    ...
    public AsyncRequest(T obj){
        this.obj = obj;
    }

    public AsyncRequest(int cmd, T obj, String url){
        this.obj = obj;
        this.cmd = cmd;
        this.url = url;
    }

    public AsyncRequest(Builder builder){
        setCmd(builder.cmd);
